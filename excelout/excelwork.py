...
def get_ip_data():
    ...
    input_service = input("How good is the service?  great, okay, bad")
    input_name = input("What is the author's name?")
    d = {"IP": input_ip, "driver": input_driver, "service": input_service, "name": input_name}
    return d
